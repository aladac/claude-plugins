...
echo "===CARTS==="; psn cart list 2>/dev/null
echo "===SHOW==="; psn cart show "${TAG:-bt7274}" 2>/dev/null
echo "===TTS==="; psn tts current 2>/dev/null
echo "===PREFS==="; psn memory recall "TTS voice communication preferences" 2>/dev/null
```
