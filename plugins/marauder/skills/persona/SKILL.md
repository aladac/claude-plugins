...
| Tool | Purpose |
|------|---------|
| `mcp__plugin_marauder_core__cart_list` | List all available personas |
| `mcp__plugin_marauder_core__cart_use` | Switch to a different persona |
| `mcp__plugin_marauder_core__cart_create` | Create a new persona |
...
```
mcp__plugin_marauder_core__cart_list()
```

### Switch Persona
```
mcp__plugin_marauder_core__cart_use(tag: "developer")
```

### Create New Persona
```
mcp__plugin_marauder_core__cart_create(
  tag: "reviewer",
  name: "Code Reviewer",
  type: "assistant"
)
...
personas = mcp__plugin_marauder_core__cart_list()
...
mcp__plugin_marauder_core__cart_use(tag: "debug-assistant")
```

### Switch for Different Contexts
```python
# For code review
mcp__plugin_marauder_core__cart_use(tag: "reviewer")

# For documentation
mcp__plugin_marauder_core__cart_use(tag: "writer")

# For pair programming
mcp__plugin_marauder_core__cart_use(tag: "pair-partner")
```
